...
## How to use it
As the application launches, the user can see the markers of the five child-friendly places in Budapest. By using the Search field, the user can filter through the places by name. By clicking on any of the sidebar elements, the user can see the bouncing marker of the exact location of the child-friendly place on the map, as well as an info-window containing its address and rating from Foursquare. By directly clicking on the marker on the map, the info-window will pop-up with the relevant information. The info-window can be closed by clicking anywhere on the map.

## Accessability
The app is fully optimized for accessibility and all functionalist's are available for all users.

## Offline Implementation
The application was created with React which supports service worker.

## APIs used
* GoogleMaps api
* Foursquare api

## Running in Development M
